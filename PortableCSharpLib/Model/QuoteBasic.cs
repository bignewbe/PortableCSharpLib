...
namespace PortableCSharpLib.TechnicalAnalysis
{
    ...
    //[DataContract]
    //public class QuoteBasic : QuoteBasicBase, IQuoteBasic
    //{
    //    public QuoteBasic(string symbol, int interval) : base(symbol, interval)
    //    {
    //    }
    ...
    //    [JsonConstructor]
    //    public QuoteBasic(string symbol, int interval, IList<long> time, IList<double> open, IList<double> close, IList<double> high, IList<double> low, IList<double> volume) 
    //        : base(symbol, interval, time, open, close, high, low, volume)
    //    {
    //    }

    //    public QuoteBasic(List<OHLC> ohlc) : base(ohlc)
    //    {
    //    }
    ...
    //    /// </summary>
    //    /// <param name="q"></param>
    //    public QuoteBasic(IQuoteBasicBase q) : base(q)
    //    {
    //    }
