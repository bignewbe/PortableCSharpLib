...
namespace PortableCSharpLib.Interface
{
    public interface IQuoteBasicMemStore
    {
        ...
        void AddQuoteBasic(IQuoteBasicBase qb, bool isAddToAll, bool isTriggerEvent, bool isAddWithGap = true);
        //void AddCandle(List<OHLC> ohlc, bool isAddToAll, bool isTriggerEvent, bool isAddWithGap = true);
        /// <summary>
        /// add single bar
        /// </summary>
        ...
        void AddCandle(string symbol, int interval, long time, double open, double close, double high, double low, double volume, 
            bool isAddToAll, bool isTriggerEvent, bool isAddWithGap);
        QuoteBasicBase GetQuoteBasic(string symbol, int interval);
        void ClearQuote(string symbol);
    }
}